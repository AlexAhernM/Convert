...
def show_messages(self, messages):
    ...
    if msg_shp:
        self.save_shp = customtkinter.CTkButton(self.checkbox_type, text=msg_shp, text_color='blue', fg_color="transparent", hover_color=self.show_files_frame.cget("fg_color"), border_width=0)
    ...
    if msg_xlx:
        self.save_xlx = customtkinter.CTkButton(self.checkbox_type, text=msg_xlx, text_color='PaleGreen4', fg_color="transparent", hover_color=self.show_files_frame.cget("fg_color"), border_width=0)

...
def generate_files_intermediate(self, doc, ruta_archivo_kml, coords, layers, coords_dec, utm_point_list, layer_names):
    return crear_dxf(self, doc, ruta_archivo_kml, coords, layers, coords_dec, utm_point_list, layer_names)


def crear_dxf(self, doc, ruta_archivo_kml, coords, layers, coords_dec, utm_points_list, layer_names):

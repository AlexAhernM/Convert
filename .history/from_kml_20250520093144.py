...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.selectfile_frame = customtkinter.CTkFrame(self, width=500, height=180)
        ...
        self.intermedio_frame = customtkinter.CTkFrame(self, width=200, height=180)
        self.intermedio_frame.grid(row=0, column = 1, padx=10, pady=10, sticky='w')
        ...
        self.checkbox_frame = customtkinter.CTkFrame(self, width=650, height=160)

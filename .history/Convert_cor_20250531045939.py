        ...
        def __init__(self, master, values):
            ...
            for i, value in enumerate(values):
                ...
                if i==0 :
                    ...
                    Rbutton.place(x=20, y=y+30)
                if i==1:
                    label.place(x=170, y=y)  # ajusta la posición y para que quede más arr
                    Rbutton.place(x=120, y=y+30)
                if i==2:
                    label.place(x=250, y=y)  # ajusta la posición y para que quede más arr
                    Rbutton.place(x=260, y=y+30)
                if i==3:
                    label.place(x=450, y=y)  # ajusta la posición y para que quede más arr
                    Rbutton.place(x=450, y=+30)

...
class VentanaSegunda:
    ...
    def abrir_ventana_kml(self):
        ...
        self.checkbox_altitude = ctk.CTkCheckBox(self.ventana_segunda, text='Get Altitude', text_color_disabled='red')
        self.checkbox_altitude.configure(state='disabled', border_width = 1, border_color = 'red', text_color='red')

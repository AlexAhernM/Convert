...
from Preview_kml import preview_kml
...
class VentanaSegunda(ctk.CTkToplevel):
    ...
    def abrir_ventana_kml(self):
        ...
        self.buttton_preview_kml = ctk.CTkButton(self, text="Preview", width=510, fg_color='black', text_color='white', font=('Arial',16),
                                                    command= lambda: preview_kml(self))
        self.buttton_preview_kml.configure(state= 'normal')
        self.buttton_preview_kml.place(x=40, y =140)

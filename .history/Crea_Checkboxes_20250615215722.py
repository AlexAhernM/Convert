...
def checkboxes_convert(self):
    class Checkbox:
        def __init__(self, master, values, enabled=True):
            ...
            for i, value in enumerate(self.values):
                ...
                inputdata.place(x=i*120+60, y=180)  # ajusta la posición según sea necesario
    ...
    self.checkbox_type = Checkbox(self, values=['DXF (CAD)', 'Shapefile', 'xlxs (Excel)', 'PDF'],  enabled=False)
    self.boton_generate_files = customtkinter.CTkButton(self, text='Generate Files', width=510, fg_color='green', text_color='white')

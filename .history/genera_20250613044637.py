...
def generate_files_intermediate(self, doc, ruta_archivo_kml, utm_coordslayers, coords_dec):
    return crear_dxf(self, doc, ruta_archivo_kml, utm_coordslayers, coords_dec)


def crear_dxf(self, doc, ruta_archivo_kml, utm_coordslayers, coords_dec):

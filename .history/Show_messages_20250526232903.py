...
def show_messages(self, messages):
    ...
    y = 20
    if msg_dxf:
        self.save_dxf = customtkinter.CTkButton(self.show_files_frame, text=msg_dxf, text_color='firebrick1', fg_color="transparent", hover_color=self.checkbox_type.cget("fg_color"), border_width=0)

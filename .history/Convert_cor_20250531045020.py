    ...
    class Rbutton:
        def __init__(self, master, values):
            ...
            for i, value in enumerate(values):
                ...
                if i==0 :
                    label.place(x=40, y=60)  # ajusta la posición y para que quede más arriba
                    Rbutton.place(x=20, y=80)
                if i==1:
                    label.place(x=170, y=60)  # ajusta la posición y para que quede más arr
                    Rbutton.place(x=120, y=80)
                if i==2:
                    label.place(x=250, y=60)  # ajusta la posición y para que quede más arr
                    Rbutton.place(x=260, y=80)
                if i==3:
                    label.place(x=450, y=60)  # ajusta la posición y para que quede más arr
                    Rbutton.place(x=450, y=80)

...
def show_messages(self, messages):
    ...
    self.boton_limpiar = customtkinter.CTkButton(self, text="CLEAN", command=lambda: widgets_destroy(self),
                               fg_color='black', text_color='white' , width = 200, height=25 ,corner_radius=6)
    self.boton_limpiar.place(x=120, y = 520)
    
    self.boton_cerrar = customtkinter.tkButton(self, text ="CLOSE",  command= close_windows,
                            fg_color='black', text_color='white' , width = 100, height=25 ,corner_radius=6)
    self.boton_cerrar.place(x = 260, y = 520)

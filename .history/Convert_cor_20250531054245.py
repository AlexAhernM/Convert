...
def convert_cor(self):
    ...
    self.checkbox_zona = customtkinter.CTkCheckBox(self.ventana_tercera)
    self.checkbox_zona.place(x=240, y= 165)
    
    self.checkbox_hemi = customtkinter.CTkCheckBox(self.ventana_tercera)
    self.checkbox_hemi.place(x=480, y= 165)
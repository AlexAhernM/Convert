        ...
        def __init__(self, master, values):
            ...
            for i, value in enumerate(values):
                ...
                if i==0 :
                    ...
                    Rbutton.place(x=x+40, y=y+30)
                if i==1:
                    label.place(x=x+150, y=y)  # ajusta la posición y para que quede más arr
                    Rbutton.place(x= x+190, y=y+30)
                if i==2:
                    label.place(x=x+300, y=y)  # ajusta la posición y para que quede más arr
                    Rbutton.place(x=x+380, y=y+30)
                if i==3:
                    label.place(x=60, y=y+60)  # ajusta la posición y para que quede más arr
                    Rbutton.place(x=65, y=y+90)

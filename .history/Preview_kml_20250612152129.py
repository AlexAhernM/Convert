...
from Transforma import parseo,  obtener_coordenadas y capas, encontrar_placemark, procesar_placemark, get_zoom_level
...
def procesar_archivo_kml(self):
    ...
    if ruta_archivo_kml: 
        ...
        doc, coords, coords_dec, layers, lat_centro, lon_centro, radio = obtener_coordenadas y capas(root_element_xml, altitud_value)

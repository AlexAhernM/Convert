...
def convert_file(self):
    ...
    self.selectdata_boton.grid(row=0, column=0)
        
    self.selectdata_entry = customtkinter.CTkEntry(self.selectfile_frame )
    self.selectdata_entry.grid(row =0, column =1)
    ...
    if self.tipo_geo.get() == "KML":
        ...
        self.checkbox_altitude = None
        self.checkbox_type = None

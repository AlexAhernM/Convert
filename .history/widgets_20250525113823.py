...
from Ventana_kml import abrir_ventana_kml
from Ventana_coord import abrir_ventana_cor
...
class VentanaPrincipal:
    def __init__(self):
        ...
        self.root.boton_inic1 = ctk.CTkButton(self.root, text='Convert your KML files into..\n CAD, Shapefile or Excel', font=('Arial',36),
                                text_color='white',width=520, height=140, fg_color='navy', 	hover_color='midnight blue',
                                command= lambda: abrir_ventana_kml(self),  corner_radius=20)
        ...
        self.root.boton_inic2 = ctk.CTkButton(self.root, text='Convert coordinates (in Excel)..\n into KML, CAD or Shapefile', font=('Arial',36),
                                text_color='white', width=520, height=140, fg_color='navy',  hover_color='midnight blue',
                                command= lambda: abrir_ventana_cor(self) ,corner_radius=20)
        ...
        imagen_tk1 = ctk.CTkImage(light_image=imagen1, dark_image=imagen1, size=(650,300))

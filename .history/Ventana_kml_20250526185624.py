...
class VentanaSegunda:
    ...
    def abrir_ventana_kml(self):
        ...
        self.show_files_frame = ctk.CTkFrame(self.ventana_segunda, fg_color='blue', width=510, height=320)
        ...
        try:                    
            ...
            self.label3 = ctk.CTkLabel(self.ventana_segunda, text='',image=imagen_tk3, width=600,height=400)

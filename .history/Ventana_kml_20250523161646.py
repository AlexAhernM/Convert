...
def abrir_ventana_kml(self):
    ...
    self.checkbox_altitude = ctk.CTkCheckBox(self, self, text='Get Altitude', enabled = False, border_width = 1, border_color = 'black')
    ...
    self.button_preview.place(x=40, y =200)

...
class VentanaSegunda:
    ...
    def abrir_ventana_kml(self):
        ...
        self.show_files_frame = ctk.CTkFrame(self.ventana_segunda, fg_color='blue', width=510, height=400)
        self.show_files_frame.place (x=40, y=180)
        
        
        imagen_3 = Image.open("D:\\OneDrive\\tuto_vscode\\Convert\\amanecer.png")
        imagen_tk3 = ctk.CTkImage(light_image=imagen_3, dark_image=imagen_3, size=(660,400))

...
class VentanaSegunda:
    def __init__(self, root):
        ...
        self.ventana_segunda.geometry('1200x600')
    ...
    def abrir_ventana_kml(self):
        ...
        self.show_files_frame = ctk.CTkFrame(self.ventana_segunda, fg_color='snow', width=510, height=320)
        self.show_files_frame.place (x=40, y=350)
        
        
        imagen_3 = Image.open("D:\\OneDrive\\tuto_vscode\\Convert\\amanecer.png")
        imagen_tk3 = ctk.CTkImage(light_image=imagen_3, dark_image=imagen_3, size=(620,340))
        
        try:                    
            
            self.label3 = ctk.CTkLabel(self.ventana_segunda, text='',image=imagen_tk3)

    ...
    class Rbutton:
        def __init__(self, master, values):
            ...
            for i, value in enumerate(values):
                ...
                label.place(x=(i+1)*150, y=80)  # ajusta la posición y para que quede más arriba
                
                Rbutton = customtkinter.CTkRadioButton(master, variable=self.var, value=i)
                Rbutton.place(x=(i+1)*150+10, y=110)  # ajusta la posición x para que quede centrado debajo del label

...
def button_preview(self):
    ...
    self.selectdata_boton.configure(state='disabled' if ruta_archivo_kml is not None else 'normal')   
    if ruta_archivo_kml: 
...
def confirmar_localizacion(self, doc, ruta_archivo_kml, coords, layers, coords_dec):
    ...
    label_mappreview = customtkinter.CTkLabel(self, text='Vision Preliminar Area Geografica a Procesar', 

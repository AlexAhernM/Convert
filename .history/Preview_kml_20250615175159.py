...
def procesar_archivo_kml(self):
    ...
    if ruta_archivo_kml: 
        ...
        confirmar_localizacion (self, doc, ruta_archivo_kml, coords, layers, coords_dec, utm_point_list, layer_names)
...
def confirmar_localizacion(self, doc, ruta_archivo_kml, coords, layers, coords_dec, utm_point_list, layer_names):
    ...
    def respuesta_confirmacion(respuesta):
        if respuesta == "incorrecta":
            ...
            generate_files(self, doc, ruta_archivo_kml, coords, layers, coords_dec, utm_point_list, layer_names) or ("", "", "")

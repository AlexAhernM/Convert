...
def crear_files(self, doc, ruta_archivo_kml, coords, utm_points_list, layer_names):
        ...
        if  pdf_selected:
            ...
            for entity in msp:
                if entity.dxftype() == 'LINE':
                    ...
                    ax.annotate(entity.dxf.layer, (entity.dxf.location[0], entity.dxf.location[1]), textcoords="offset points", xytext=(0, 10), ha='center')
                    ...
                    ax.annotate(entity.dxf.layer_names, (entity.dxf.location[0], entity.dxf.location[1]), textcoords="offset points", xytext=(0, 10), ha='center')
    ...
    self.checkboc_type.checkboxes[3].configure(state ='disabled')   
    self.checkbox_type.checkboxes[3].deselect()

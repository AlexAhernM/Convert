...
def convert_cor(self):
    ...
    self.slider = customtkinter.CTkSlider(self.ventana_tercera, from_=1, to=60, variable=self.zona_var, number_of_steps=59)
    self.slider.place(x=150, y=165)
    
    self.label_valor = customtkinter.CTkLabel(self.ventana_tercera, text = 'Zona Geografica')
    self.label_valor.place(x=180, y=140)
    
    self.label_valor = customtkinter.CTkLabel(self.ventana_tercera, textvariable = self.zona_var)
    self.label_valor.place(x=220, y=180)

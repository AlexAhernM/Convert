                ...
                if entity.dxftype() == 'LINE':
                    ...
                    if entity.has_xdata('ACAD'):
                        ...
                        for code, value in xdata:
                            if code == 1000 and value == 'CIRCULO':# Es un círculo creado en el script TRANFORMA
                                ...
                                for texto in textos_existentes:
                                    ...
                                    if  distancia<20: # ajustar distancia s/ necesario
                                        cerca_de_texto = True
                                        break
                                if not cerca_de_texto:        
                                    ax.annotate(entity.dxf.layer, (sum(x[:-1])/len(x[:-1]), sum(y[:-1])/len(y[:-1])), ha='center',
                                            fontsize = 3, fontname = 'Arial',textcoords="offset points", xytext=(0, 5) )

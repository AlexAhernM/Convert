...
def abrir_ventana_kml(self):
    ...
    self.checkbox_altitude = ctk.CTkCheckBox(self, self, text='Get Altitude')
    self.checkbox_altitude.configure(state='disabled', border_width = 1, border_color = 'black')
    self.checkbox_altitude.place( x=80, y= 110)
    ...
    self.button_preview.place(x=40, y =240)

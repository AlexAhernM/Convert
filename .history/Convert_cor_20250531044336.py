    ...
    class Rbutton:
        def __init__(self, master, values):
            ...
            for i, value in enumerate(values):
                ...
                if i==1:
                    label.place(x=150, y=80)  # ajusta la posición y para que quede más arr
                    Rbutton.place(x=120, y=80)
                if i==2:
                    label.place(x=250, y=80)  # ajusta la posición y para que quede más arr
                    Rbutton.place(x=220, y=80)
                if i==3:
                    label.place(x=350, y=80)  # ajusta la posición y para que quede más arr
                    Rbutton.place(x=320, y=80)

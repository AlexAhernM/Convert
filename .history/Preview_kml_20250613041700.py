...
def procesar_archivo_kml(self):
    ...
    if ruta_archivo_kml: 
        ...
        doc, coords, coords_dec, layers, lat_centro, lon_centro, radio = obtener_coordenadas_capas(root_element_xml, altitud_value)
        print ('coords=', coords)
        print ('coords dec=', coords_dec)
        print ('layers =', layers)
        print ('lat centro=', lat_centro)
        print ('lon centro=', lon_centro)

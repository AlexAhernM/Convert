# Este script crea un mapa con marca de posicion por defecto y una imagen del area marcada
...
# create marker through .set_position() with image, which is visible at zoom levels 14 to infinity
marker_1 = map_widget.set_position(52.5163, 13.3777, marker=True, image=tor_image, image_zoom_visibility=(14, float("inf")))  # Coordenadas de Brandenburger Tor

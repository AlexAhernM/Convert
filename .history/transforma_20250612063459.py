...
def parseo(ruta_archivo_klm, checkbox_frame_2_get):
    ...
    try:
        ...
        root_element_xml = tree.getroot_element_xml()
...
def convierte(root_element_xml, altitude_value):
    doc = ezdxf.new('R2013')
    coords = []
    layers = []
    coords_dec = []
...
def obtener_coordenadas(coord, layer_name,  altitud_value ,coords, layers, coords_dec):

                ...
                if entity.dxftype() == 'LINE':
                    ...
                    if entity.vertices:
                        ...
                        if len(x) > 2 and x[0] == x[-1] and y[0] == y[-1]:  # Si es un círculo
                            ...
                            ax.annotate(entity.dxf.layer, (sum(x[:-1])/len(x[:-1]), sum(y[:-1])/len(y[:-1])), ha='center')  # Colocar el nombre de la capa
                        else:
                            ax.plot(x, y, 'k-')  # Dibujar la polilínea
                            ax.plot(x[0], y[0], 'ko')  # Dibujar un punto en el inicio de la polilínea
                            ax.annotate(entity.dxf.layer, (x[0], y[0]), textcoords="offset points", xytext=(0, 10), ha='center')  # Colocar el nombre de la capa
                    ...
                    if entity.vertices:
                        ...
                        print(f"Advertencia: Ignorando entidad POLYLINE sin vértices.")
